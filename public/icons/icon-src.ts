...
export const shadcn = '/icons/shadcn.svg'
export const laravelIcon = '/icons/laravel.svg'
export const springIcon = '/icons/spring.svg'
export const sqliteIcon = '/icons/sqlite.svg'
export const postgreIcon = '/icons/postgresql.svg'
